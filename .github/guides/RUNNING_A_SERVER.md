...
```
saving dragonfall.dmb (DEBUG mode)
dragonfall.dmb - 0 errors, 0 warnings
```
...
compiled dragonfall.dmb file. Make sure to set the port to the one you
...
8. Tell TGS4 to fetch and deploy. If everything goes according to plan, your server will be compiled and the resource uploaded automatically to amazon S3. You can verify that by checking on the file your bucket via aws web management.
