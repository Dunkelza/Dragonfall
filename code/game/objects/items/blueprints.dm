...
/obj/item/areaeditor/blueprints
	...
	icon = 'icons/obj/items_and_weapons.dmi'
	icon_state = "blueprints"
	fluffnotice = "Property of Renraku Computer Systems. For executives only. Store in high-security storage."
...
/obj/item/areaeditor/blueprints/cyborg
	...
	icon = 'icons/obj/items_and_weapons.dmi'
	icon_state = "blueprints"
	fluffnotice = "Intellectual Property of Shiawase Industrial. For use in engineering cyborgs only. Wipe from memory upon departure from the station."
...
/proc/set_area_machinery_title(area/area, title, oldtitle)
	...
	for(var/obj/machinery/airalarm/airpanel in area.airalarms)
