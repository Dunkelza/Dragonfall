...
/obj/item/station_charter/banner/rename_station(designation, uname, ureal_name, ukey)
	...
	desc = "The banner bears the official corporate seal of Renraku Computer Systems, signifying that [station_name()] has been claimed by Executive [uname] in the name of the company."
	SSblackbox.record_feedback("text", "station_renames", 1, "[station_name()]")
	if(!unlimited_uses)
		used = TRUE
