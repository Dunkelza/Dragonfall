...
/obj/item/book/manual/ripley_build_and_repair
	...
	starting_content = {"<html>
				...
				<li>Install the internal armor plating (Not included due to Renraku safety policy. Can be made using 5 iron sheets.)</li>
				<li>Secure the internal armor plating with a wrench</li>
				<li>Weld the internal armor plating to the chassis</li>
				<li>Install the external reinforced armor plating (Not included due to Renraku safety policy. Can be made using 5 reinforced iron sheets.)</li>
				...
				<h2>Operation</h2>
				Please consult the Ananke compendium "Robotics for Dummies".
			"}
...
/obj/item/book/manual/nuclear
	...
	starting_content = {"<html>
			...
			Today's crash course will deal with the operation of a Fusion Class Mitsuhama-made Nuclear Device.<br>
			...
			Note: Mitsuhama Corporate Security is a pain in the neck.<br>
			...
			Intelligence Analysts believe that normal Mitsuhama procedure is for the Captain to secure the nuclear authorisation disk.<br>
			Good luck!
			</body>
			</html>"}
...
/obj/item/book/manual/wiki/chemistry
	...
	starting_author = "Shiawase Biotech"
...
/obj/item/book/manual/wiki/security_space_law
	name = "Space Law"
	desc = "A set of Lone Star guidelines for keeping law and order in corporate facilities."
	icon_state = "bookSpaceLaw"
	starting_author = "Lone Star Security Services"
...
/obj/item/book/manual/wiki/detective
	...
	starting_author = "Lone Star Investigations Division"
...
/obj/item/book/manual/codex/supermatter
	...
	desc = "An entry of the Renraku Facilities Practices. This one concerns the operation of supermatter engines."
	icon_state = "bookdsp"
