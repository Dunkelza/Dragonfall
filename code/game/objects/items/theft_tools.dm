...
/obj/item/paper/guides/antag/nuke_instructions
	info = "How to break into a Renraku self-destruct terminal and remove its plutonium core:<br>\
	<ul>\
...
/obj/item/paper/guides/antag/hdd_extraction
	info = "<h1>Source Code Theft & You - The Idiot's Guide to Crippling Renraku Research & Development</h1><br>\
	Rumour has it that Renraku are using their R&D servers to create something awful! They've codenamed it Project Goon, whatever that means.<br>\
	...
	<li>Renraku is a corporation not known for subtlety in design. You should be able to identify the master server by any distinctive markings.</li>\
