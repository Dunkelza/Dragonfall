...
/obj/machinery/deployable_turret/hmg
	...
	desc = "A heavy calibre machine gun commonly used by Lone Star High Threat Response teams, famed for its ability to give people on the receiving end more holes than normal."
	icon_state = "hmg"
	max_integrity = 250
