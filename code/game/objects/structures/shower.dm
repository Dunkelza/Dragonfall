...
/obj/machinery/shower
	name = "shower"
	desc = "The HS-452. Installed in the 2060s by Renraku Facilities, now with updated safety compliance. Passively replenishes itself with water when not in use."
