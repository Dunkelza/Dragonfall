...
/datum/gang_theme/construction_company_audit
	...
	gang_objectives = list(
		...
		/datum/antagonist/gang/irs = "Congratulations, agent! You've been assigned to the Internal Revenue Service case against Renraku and Majima Construction. \
		We are proud of your success as an agent so far, and are excited to see what you can bring to the table today. We suspect that Renraku and Majima Construction are engaging \
...
/datum/gang_theme/wild_wasteland
	...
	description = "Hey everybody, this is Three Dog, your friendly neighborhood disc jockey on 207.7! Today we got a shoutout to our man, the Captain on the Renraku station in SSC territory! \
	...
	gang_objectives = list(
		...
		/datum/antagonist/gang/pg = "Alright buddy, we're in business now. It's time for us to strike back at Renraku. \
		They kept us, ALL of us in their damn debt slave labor prisons for years over minor debts and mistakes. \
		Ensure nobody else has to suffer under Renraku's unlawful arrests by destroying the permabrig and the brig cells! \
...
/datum/gang_theme/steelport_shuffle
	...
	description = "Tonight on C-SPAM, the United Space Nations is wrapping up their convention on Silicon Rights. Renraku lobbyists have been rumored to be paying off electors, with \
	serious opposition from the Spinward Stellar Coalition, known for their strict stance on AI rights being guaranteed within their territory. Reports from Renraku stations claim that \
	...
	gang_objectives = list(
		...
		We stan AI rights! ^_^ XD #FreeAI #FragRenraku #SyntheticDawn \
		Ensure there is an AI on the station, and that it's laws are purged.\
		Renraku will NOT get away with their ABUSE of INNOCENT AI LIVES! >_<"
	)
...
/datum/gang_theme/space_rosa
	...
	their comments on these scandals, but none have replied. News broke after a high profile break-in at a Mitsuhama research facility resulted in the arrests of agents linked to these \
	three companies. All three companies denied any involvement, but the arrested individuals were found in an all out brawl. Curiously, Mitsuhama reported nothing of value had \
