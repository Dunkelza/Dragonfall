...
/obj/item/paper/pamphlet/radstorm
	...
	info = "Has your station's preemptive radstorm safety alarm gone off and you don't see a nearby maintenance hatch to escape to? Never fear, for Renraku truly thinks of everything! \
...
/obj/item/paper/pamphlet/gateway
	info = "<b>Welcome to the Shiawase Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the Shiawase Gateway project has to offer.<br>\
			<br>Because we care about you, we feel it is only fair to make sure you know the risks \
			before you commit to joining the Shiawase Gateway project. All away destinations have \
			been fully scanned by a Shiawase expeditionary team, and are certified to be 100% safe. \
			We've even left a case of space beer along with the basic materials you'll need to expand \
			Shiawase's operational area and start your new life.<br><br>\
			<b>Gateway Operation Basics</b><br>\
			All Shiawase approved Gateways operate on the same basic principals. They operate off \
			...
			As a participant in the Shiawase Gateway Project, you will be on the frontiers of space. \
