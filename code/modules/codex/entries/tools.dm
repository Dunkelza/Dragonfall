...
/datum/codex_entry/tool/crowbar
	name = "Crowbar"
	mechanics_text = "&nbsp;&nbsp;&nbsp;&nbsp;Capable of removing floor tiles or forcing open unpowered doors. Used for construction, or bashing your boss' skull inwards."
...
/datum/codex_entry/tool/multitool
	...
	mechanics_text = {"
		...
		<br>
		Using a multitool on a blinking light will return it to normal function.
	"}
